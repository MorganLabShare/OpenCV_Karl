...
ax1=plotExamples.add_subplot(111)
...
for i in range(len(imlist)):
  ...
  #~ print(plotFlow1x[-1])
  #~ ,plotFlow1y,plotFlow2x,plotFlow2y)
  
  ax1.clear()
  sleep(0.05)
  plt.plot(range(i+1),plotFlow1y,'g--')
  plt.plot(range(i+1),plotFlow2y,'b--')
  plt.plot(range(i+1),plotFlow1x,'g-')
  plt.plot(range(i+1),plotFlow2x,'b-')
